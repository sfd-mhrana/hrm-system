  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            {isAdmin ? "Manage all leave requests" : "Your leave requests"}
          </p>
        </div>
        {!isAdmin && (
          <LeaveRequestDialog onLeaveRequested={fetchLeaves} open={openDialog} onOpenChange={setOpenDialog} />
        )}
      </div>
      ...
      <Card>
        ...
        <CardContent>
          {leaves.length === 0 ? (
            <p className="text-slate-600 dark:text-slate-400 text-center py-10">No leave requests</p>
          ) : (
